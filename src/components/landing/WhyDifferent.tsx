...
const differentials = [
  {
    ...
    highlight: "Liberdade para servir do seu jeito",
    color: "text-primary",
  ...
  },
  {
    ...
    highlight: "Justiça e transparência",
    color: "text-blue-500",
  ...
  },
  {
    ...
    description: "O cliente vai pro SEU canal — você conversa, entende o que ele precisa e cuida. Sem intermediários.",
    highlight: "Cuide de quem confia em você",
  ...
  },
  {
    ...
    description: "Feito para negócios locais que querem servir e ser encontrados na própria cidade. Crescimento onde importa.",
    highlight: "Sua cidade, sua comunidade",
    color: "text-rose-500",
