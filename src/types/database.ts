...
export const CONFIG = {
  ...
  // Fórmula: CPL = (14 - Nota) × 33.33 centavos
  MIN_CPL: 100,          // R$ 1,00 em centavos (Nota 10)
  MAX_CPL: 300,          // R$ 3,00 em centavos (Nota 4)
  DEFAULT_CPL: 200,      // R$ 2,00 em centavos (Nota 7)
  ...
  CPL_PLATFORM_PROFIT: 140, // ~70% do CPL médio (R$ 2,00)
  CPL_PAYOUT_AFFILIATE: 60, // ~30% do CPL médio
